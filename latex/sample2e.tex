...
del fatto che \ldots \LaTeX \today ''\,'prova'\,''.

Per i trattini:
questo raggi-X è un trattino singolo
questo 1--2 è un trattino doppio
questo --- è un trattino triplo.

Per il punto. in questo modo non vado a capo.

I seguenti simboli \$ \& \% \# \_ \{ \} si producono usando l'escape prima del carattere.
