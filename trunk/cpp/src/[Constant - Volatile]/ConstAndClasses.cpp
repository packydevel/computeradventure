...
int main25() {
	...
	c1.memberFunction();
	c1.constMemberFunction();

	const C c2(0);

	//c2.memberFunction(); //ERROR!!! It is possible to call only const member function of c2.
	c2.constMemberFunction(); //OK
	c2.discardConstMemberFunction(); //OK
}
