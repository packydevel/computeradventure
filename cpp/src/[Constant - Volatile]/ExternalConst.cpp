...
int main22() {
	cout << "The value of CONSTANT1 is: " << CONSTANT1;
	//cout << "The value of CONSTANT2 is: " << CONSTANT2; //ERROR!!! No reference to CONSTANT2
	//cout << "The value of CONSTANT3 is: " << CONSTANT3; //ERROR!!! No reference to CONSTANT3
}
