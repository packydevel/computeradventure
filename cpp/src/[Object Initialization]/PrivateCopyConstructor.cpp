...
int main16() {
	...
	//PrivateCopyConstructor pcp2 = pcp1; //ERROR!!! Assignement will attempt to call the copyconstructor
	//PrivateCopyConstructor pcp3(pcp1); //ERROR!!! Alternative Assignement will attempt to call the copyconstructor
